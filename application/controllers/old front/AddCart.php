		   ...
		   return error_404();
			...
			if (empty($this->api)){
				...
				$return = [
					'error'   => FALSE,
					'count'   => count($cart),
				    'message' => '<div class="notification"><h3 class="notification-title"><a href="'.base_url('cart').'">Added to cart</a></h3><div class="media-object margin-0"><div class="media-object-section"><div class="thumbnail"><a href="'.base_url('single-product/'.$product['slug'].'/'.$prod_id).'" class="product-image"> <img src="'.$product['image'].'" alt="'.$product['eng_name'].'" class="notification-image"></a></div></div><div class="media-object-section"><h4 class="notification-product-title"><a href="'.base_url('cart').'">'.$product['eng_name'].'<br> '.$product['guj_name'].'</a></h4><div class="notification-product-price">'.$product['price'].'</div><div class="notification-link"><a href="'.base_url('cart').'">My shopping Cart</a></div></div></div></div>'
				];

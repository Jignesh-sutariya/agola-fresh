        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="pincode" class="form-control number" id="pincode" placeholder="Enter Pincode" value="<?= (!empty(set_value('pincode'))) ? set_value('pincode') : $data['pincode'] ?>" maxlength="6" />
              <?= form_error('pincode') ?>
            </div>
          </div>
        </div>

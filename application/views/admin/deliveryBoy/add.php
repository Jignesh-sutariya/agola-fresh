        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="fullname" class="form-control" id="fullname" placeholder="Enter Fullname" value="<?= set_value('fullname') ?>" />
              <?= form_error('fullname') ?>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="mobile" class="form-control number" id="mobile" placeholder="Enter Mobile No." value="<?= set_value('mobile') ?>" maxlength="10" />
              <?= form_error('mobile') ?>
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="address" class="form-control" id="address" placeholder="Enter Address"><?= set_value('address') ?></textarea>
              <?= form_error('address') ?>
            </div>
          </div>
        </div>
